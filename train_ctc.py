...
def get_model(img_size):
    ...
    conv1 = layers.Conv3D(8, 3, activation='relu', padding="same",
...
def train():
    ...
    train_gen = cell_data('/home/tom/ctc_train/Fluo-C3DL-MDA231/01',
                          '/home/tom/ctc_train/Fluo-C3DL-MDA231/01_GT')
